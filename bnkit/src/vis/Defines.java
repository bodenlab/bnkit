...
public class Defines {
    ...
    public static final int G_ID = 2;
    public static final int G_X = 3;
    public static final int G_CONSENSUS = 5;
    public static final int G_SEQ = 6;
    public static final int G_GRAPH = 7;
    public static final int G_MUTANTS = 8;
