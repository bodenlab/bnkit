...
public class PriorExample {
    ...
    public static void rootExample() {
        ...
        EnumDistrib d = EnumDistrib.uniform(sun.getDomain());
        cpt.put(d);
...
//        cpt.maximizeInstance();
    ...
    /**
     * This example has two nodes, sun rise node and rain node. each of them has
     * prior.
     */
    public static void complexExample(Boolean[][] data) {
        ...
        /**
         * Node that when set prior, the order of parent value should be the
         * same as the one used in constructor of CPTPrior
         */
