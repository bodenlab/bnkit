...
public class ParsimonyTests {
    ...
    Tree tree1 = Tree.parseNewick("((((x01,x02)X01_02,x03)X01_03,(x04,((x05,x06)X05_06,(x07,x08)X07_08)X05_08)X04_08)X01_08,(x09,(x10,x11)X10_11)X09_11)X01_11;");

    @BeforeAll
    public static void setUp() throws Exception {
        try {
            trees = new Tree[] { // MB: also successfully tried a 150-seq tree with alignment (not in test/resources)
                    Tree.loadNewick("bnkit/src/test/resources/large.nwk"),
                    Tree.loadNewick("bnkit/src/test/resources/default.nwk"),
            };
    ...
    public void testParsimony1() throws Exception {
        Tree.BranchPoint.SET_ONE_TARGET_PARSIMONY = true;
        Tree.BranchPoint.SET_RANDOM_PARSIMONY = true;
        for (int i = 0; i < trees.length; i ++) {
...
/*                    System.out.printf("\t%3.0f\n", score);
    ...
    public void testParsimony2() throws Exception {
        Tree.BranchPoint.SET_ONE_TARGET_PARSIMONY = false;
        Tree.BranchPoint.SET_RANDOM_PARSIMONY = false;
        ...
        Tree.BranchPoint n = tree1.find("N2_X01_03");
        if (n != null) {
