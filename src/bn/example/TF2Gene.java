...
public class TF2Gene {
     ...
     * @param vars variables to include from the data file, excluding those in the file that are not mentioned
     * @return a TSVFile object with the specified variables in the same order, but excluding those that weren't found in the file
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //map.test(genedata_tst.getRows(), genevars_arr, new EnumVariable[] {tfvars.get(0), tfvars.get(1), tfvars.get(2)});
        } catch (IOException e) {
